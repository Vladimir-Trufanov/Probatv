...
php ServerForHTML5.php

ClientForHTML5.html

Затем откройте http://localhost/ClientForHTML5.html в нескольких разных вкладках. При загрузке страницы будет открыто соединение WebSocket. Так, например, если вы открыли этот URL-адрес на трех разных вкладках, будет три клиентских соединения WebSocket.
