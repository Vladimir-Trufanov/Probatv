<?php
/*
 *********************************************** wsRusakov/rusEx2/index.php ***
 
 Клиент на PHP, который отправляет запрос на сервер и получает от него ответ.

 Алгоритм работы клиента: создание сокета, подключение к серверу, отправка запросов, 
 получение ответов, закрытие соединения. 
 
 Как работает: клиент отправляет число. Сервер это число возводит в квадрат и 
 возвращает вычисленное значение.
 Поэтому если Вы укажете 15, то увидите от сервера 225 (15*15). 
 Потом мы подаём команду shutdown, которая останавливает сервер.
*/
